  ...
  >
    ...
    >
      ...
      <el-form-item label="个人首页头图">
        <el-select
            v-model="accountSetting.coverPhotoId"
            filterable>
          <el-option
    ...
    <div class="setting-item">
      ...
      <div>允许我们在不事先通知您的情况下，将您的图片发布在TOGAPhotos所属的社交媒体上</div>
      <el-radio-group v-model="accountSetting.toga">
        <el-radio :value="true" size="large">授权</el-radio>
        <el-radio :value="false" size="large"><span class="red-font">撤销授权</span></el-radio>
      </el-radio-group>
    </div>
    <div class="setting-item">
      <h4>授权第三方使用您的图片</h4>
      <div>
        允许我们的合作伙伴在遵循 CC BY-NC-ND 4.0 协议的情况下，可以在使用图片时不事先与您取得联系
      </div>
      <div style="font-size: 0.8em">
        <strong>CC BY-NC-ND 4.0 协议</strong>:简单来说，这项协议要求使用者遵守三个限制：需要以适当的方式署名作者；不可以将您的作品用于商业用途；不可以对您的作品进行二次加工。
      </div>
