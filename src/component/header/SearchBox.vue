...
<template>
    <div v-if="!isMobile" class="mt-4 input-box" :class="!isFocus && inputContent === '' ? 'blur' : ''">
      <el-input
    ...
    <div v-else>
        <div class="mobile-search-btn" @click="showMobileSearchBox = !showMobileSearchBox" ref="mobileSearchButton">
            <el-icon class="search-icon"><Search /></el-icon>
        </div>
        <div v-show="showMobileSearchBox" class="mobile-input-container" ref="mobileSearchBox">
            <el-input
            v-model="inputContent"
            placeholder="搜索注册号、机型、机场、摄影师等信息"
